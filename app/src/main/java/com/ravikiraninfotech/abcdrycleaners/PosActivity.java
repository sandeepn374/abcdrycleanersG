...
public class PosActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    Button btText,btBarCode,btImage,btQRcode,checklink,btTextToken;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.ravikiraninfotech.abcdrycleaners.R.layout.activity_pos);

        Intent intent = getIntent();

        Bundle b = getIntent().getExtras();

        message1=b.getString("MESSAGE1");
        message2=b.getString("MESSAGE2");
    ...
    private void initview(){
        btTextToken=(Button) findViewById(com.ravikiraninfotech.abcdrycleaners.R.id.btTextToken);
        container= (CoordinatorLayout) findViewById(com.ravikiraninfotech.abcdrycleaners.R.id.activity_pos);
        btText= (Button) findViewById(com.ravikiraninfotech.abcdrycleaners.R.id.btText);
        btBarCode= (Button) findViewById(com.ravikiraninfotech.abcdrycleaners.R.id.btbarcode);
        btImage= (Button) findViewById(com.ravikiraninfotech.abcdrycleaners.R.id.btpic);
        btQRcode= (Button) findViewById(com.ravikiraninfotech.abcdrycleaners.R.id.qrcode);
        imageView= (ImageView) findViewById(com.ravikiraninfotech.abcdrycleaners.R.id.image);
        rl= (RelativeLayout) findViewById(com.ravikiraninfotech.abcdrycleaners.R.id.rl);
        text= (EditText) findViewById(com.ravikiraninfotech.abcdrycleaners.R.id.text);
        checklink= (Button) findViewById(com.ravikiraninfotech.abcdrycleaners.R.id.checklink);
        tip= (TextView) findViewById(com.ravikiraninfotech.abcdrycleaners.R.id.tv_net_disconnect);
    }

    private void setListener(){
        btText.setOnClickListener(this);
        btTextToken.setOnClickListener(this);
    ...
    public void onClick(View view) {
        int id=view.getId();
        switch (id){
            case com.ravikiraninfotech.abcdrycleaners.R.id.btText:
                text.setText(message1);
                printText();
                break;
            case com.ravikiraninfotech.abcdrycleaners.R.id.btTextToken:
                text.setText(message2);
                printTextToken();
                break;
            case com.ravikiraninfotech.abcdrycleaners.R.id.btbarcode:
                printBarcode();
                break;
            case com.ravikiraninfotech.abcdrycleaners.R.id.qrcode:
                printQRcode();
                break;
            case com.ravikiraninfotech.abcdrycleaners.R.id.btpic:
                printPIC();
                break;
            case com.ravikiraninfotech.abcdrycleaners.R.id.checklink:
                checklink();
                break;
        }
    }
                ...
                new UiExecute() {
                    ...
                    public List<byte[]> processDataBeforeSend() {
                        ...
                        if (str.equals(null)||str.equals("")){
                            showSnackbar(getString(com.ravikiraninfotech.abcdrycleaners.R.string.text_for));
                        }else {
...
//                            list.add( DataForSendToPrinterPos58.initializePrinter());
    ...
    /*
    print barcode
	before you print the barcode ,you should set attribute of the barcode,for ravikiraninfotech :width ,height ,HRI.
     */
    ...
    Some of the necessary settings, you need to refer to the ravikiraninfotech of the programming manual,
