...
public class TscActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.ravikiraninfotech.abcdrycleaners.R.layout.activity_tsc);
    ...
    private void initView() {
        btcontent= (Button) findViewById(com.ravikiraninfotech.abcdrycleaners.R.id.content);
        bttsctext= (Button) findViewById(com.ravikiraninfotech.abcdrycleaners.R.id.tsctext);
        bttscbarcode= (Button) findViewById(com.ravikiraninfotech.abcdrycleaners.R.id.tscbarcode);
        bttscpic= (Button) findViewById(com.ravikiraninfotech.abcdrycleaners.R.id.tscpic);
        relativeLayout= (RelativeLayout) findViewById(com.ravikiraninfotech.abcdrycleaners.R.id.rlimage);
        imageView= (ImageView) findViewById(com.ravikiraninfotech.abcdrycleaners.R.id.image);
        container = (CoordinatorLayout) findViewById(com.ravikiraninfotech.abcdrycleaners.R.id.activity_tsc);
        btTest= (Button) findViewById(com.ravikiraninfotech.abcdrycleaners.R.id.test);
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case com.ravikiraninfotech.abcdrycleaners.R.id.content:
                printContent();
                break;
            case com.ravikiraninfotech.abcdrycleaners.R.id.tsctext:
                printText();
                break;
            case com.ravikiraninfotech.abcdrycleaners.R.id.tscbarcode:
                printBarcode();
                break;
            case com.ravikiraninfotech.abcdrycleaners.R.id.tscpic:
                printPic();
                break;
            case com.ravikiraninfotech.abcdrycleaners.R.id.test:
                test();
                break;
        }
